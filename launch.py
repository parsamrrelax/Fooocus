...
vae_approx_filenames = [
    ('xlvaeapp.pth', 'https://huggingface.co/Mrrelax/pp/resolve/main/misc/xlvaeapp.pth'),
    ('vaeapp_sd15.pth', 'https://huggingface.co/Mrrelax/pp/resolve/main/misc/vaeapp_sd15.pt'),
...
def download_models(default_model, previous_default_models, checkpoint_downloads, embeddings_downloads, lora_downloads, vae_downloads):
    ...
    load_file_from_url(
        url='https://huggingface.co/Mrrelax/pp/resolve/main/misc/fooocus_expansion.bin',
